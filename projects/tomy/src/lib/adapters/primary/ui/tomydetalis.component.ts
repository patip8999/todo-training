...
export class TomydetalisComponent {
  tomy$: Observable<TomyDTO> = this._getsOneTomyDto.getOne('TSMUqAj7fk7LkOUvcN2N');

  constructor(@Inject(GETS_ONE_TOMY_DTO) private _getsOneTomyDto: GetsOneTomyDtoPort) {
  }
}
